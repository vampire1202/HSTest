...
namespace HR_Test.DAL
{
	...
	public partial class GBT236152009_Method
	{
		...
		public int GetMaxId()
		{
		return DbHelperOleDb.GetMaxID("ID", "tb_GBT236152009_Method"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from tb_GBT236152009_Method");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_GBT236152009_Method(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_GBT236152009_Method set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_GBT236152009_Method ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public HR_Test.Model.GBT236152009_Method DataRowToModel(DataRow row)
		{
			HR_Test.Model.GBT236152009_Method model=new HR_Test.Model.GBT236152009_Method();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,methodName,testStandard,testType,xmlPath,selResultID,isProLoad,proLoadType,proLoadValue,proLoadControlType,proLoadSpeed,isLxqf,controlType1,controlType2,controlType3,controlType4,controlType5,controlType6,controlType7,controlType8,controlType9,controlType10,controlType11,controlType12,circleNum,stopValue,isTakeDownExten,extenChannel,extenValue,sendCompany,stuffCardNo,stuffSpec,stuffType,hotStatus,temperature,humidity,testMethod,mathineType,testCondition,sampleCharacter,getSample,condition,controlmode,tester,assessor,sign ");
			strSql.Append(" FROM tb_GBT236152009_Method ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_GBT236152009_Method T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_GBT236152009_Method";
