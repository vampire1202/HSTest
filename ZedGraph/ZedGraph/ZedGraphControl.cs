...
*/
	...
	#region Methods
        ...
        {
            //this.GraphPane.XAxis.Scale.MajorStep = (this.GraphPane.XAxis.Scale.Max - this.GraphPane.XAxis.Scale.Min) / 5;
            //this.GraphPane.YAxis.Scale.MajorStep = (this.GraphPane.YAxis.Scale.Max - this.GraphPane.YAxis.Scale.Min) / 5;
            //this.GraphPane.XAxis.Scale.MinorStep = this.GraphPane.XAxis.Scale.MajorStep / 5;
            //this.GraphPane.YAxis.Scale.MinorStep = this.GraphPane.YAxis.Scale.MajorStep / 5;
