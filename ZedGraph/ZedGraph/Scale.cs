...
namespace ZedGraph
{
    ...
    abstract public class Scale : ISerializable
    {
        ...
        public struct Default
        {
            ...
            /// </summary>
            public static double MaxTextLabels = 5.0;
            /// <summary>
            ...
            /// <see cref="Default"/> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetXSteps = 5.0;
            /// <summary>
            ...
            /// <see cref="Default"/> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetYSteps = 5.0;
            /// <summary>
            ...
            /// <see cref="Default"/> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetMinorXSteps = 3.0;
            /// <summary>
            ...
            /// <see cref="Default"/> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetMinorYSteps = 3.0;
            /// <summary>
            ...
            */
            ...
            /// </remarks>
            public static float EdgeTolerance = 5;
            ...
            /// the major tic size.
            /// </summary>
            public static float LabelGap = 0.0f;
        }
        ...
        */
        ...
        internal void SetRange(GraphPane pane, Axis axis)
        {
            if (_rangeMin >= Double.MaxValue || _rangeMax <= Double.MinValue)
            {
                ...
                if (axis != pane.XAxis && axis != pane.X2Axis && pane.Y2Axis.Scale._rangeMin < double.MaxValue && pane.Y2Axis.Scale._rangeMax > double.MinValue)
                {
                ...
                //else if (axis != pane.XAxis && axis != pane.X2Axis && pane.YAxis.Scale._rangeMin < double.MaxValue && pane.YAxis.Scale._rangeMax > double.MinValue)
                //{
