...
namespace HR_Test.BLL
{
    ...
    {
        private readonly HR_Test.DAL.GBT3354_Samples dal = new HR_Test.DAL.GBT3354_Samples();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public HR_Test.Model.GBT3354_Samples GetModelByCache(int ID)
        {

            string CacheKey = "GBT3354_SamplesModel-" + ID;
            ...
            return (HR_Test.Model.GBT3354_Samples)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<HR_Test.Model.GBT3354_Samples> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HR_Test.Model.GBT3354_Samples> DataTableToList(DataTable dt)
        {
            List<HR_Test.Model.GBT3354_Samples> modelList = new List<HR_Test.Model.GBT3354_Samples>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                HR_Test.Model.GBT3354_Samples model;
