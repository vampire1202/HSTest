...
namespace HR_Test.Input
{
    ...
    /// </summary>
    public partial class GBT28289_2012Shear : UserControl
    {
        ...
        private void gBtnAddTestSample_Click(object sender, EventArgs e)
        {
            ...
            string lastChar = this._testNo.Text.Trim().Substring(this._testNo.Text.Trim().Length-1,1);

            //判断试验编号最后一位是否为 L R H 的任何一字母
            if (lastChar  == "R" || lastChar  == "H" || lastChar  == "L")
            { }
            else
            {
                strErr += "'试验编号'要求输入温度标志: \r\n高温试验以'H'结束\r\n室温试验以'R'结束\r\n低温试验以'L'结束;\r\n\r\n";
            }
            ...
            Model.GBT282892012_Shear model = new HR_Test.Model.GBT282892012_Shear(); 
            ...
            BLL.GBT282892012_Shear bll = new BLL.GBT282892012_Shear();
