...
namespace HR_Test.Input
{
    ...
    /// </summary>
    public partial class GBT28289_2012Tensile : UserControl
    {
        ...
        private void gBtnAddTestSample_Click(object sender, EventArgs e)
        {
            ...
            Model.GBT282892012_Tensile model = new HR_Test.Model.GBT282892012_Tensile(); 
            ...
            BLL.GBT282892012_Tensile bll = new BLL.GBT282892012_Tensile();
