        ...
        private void frmAnalysiseCurve_Load(object sender, EventArgs e)
        {
            ...
            if (m_m != null)
            {
                if (this.flowLayoutPanel1.Controls.Find("Fm", false).Length > 0)
                {
                    ...
                    //lblFm.Text = (m_Fm / 1000.0).ToString("G5");
        ...
        void _palZoom_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (m_FlagFp02L)
                {
                    ...
                    //添加 值 的标注
                    ZedGraph.TextObj t = new TextObj("Fp02 = " + (_List_Data[m_FrIndex].F1 / 1000).ToString("G5") + " kN\r\n" + "Rp02 =" + (_List_Data[m_FrIndex].YL1).ToString("G5") + " MPa", _List_Data[m_FrIndex].D1, _List_Data[m_FrIndex].F1);
                ...
                if (m_FlagFp02E)
                {
                    ...
                    //添加 值 的标注
                    ZedGraph.TextObj t = new TextObj("Fp02 = " + (_List_Data[m_FrIndex].F1 / 1000).ToString("G5") + " kN\r\n" + "Rp02 =" + (_List_Data[m_FrIndex].YL1).ToString("G5") + " MPa", _List_Data[m_FrIndex].BX1, _List_Data[m_FrIndex].F1);
                    t.FontSpec.FontColor = Color.Navy;
                    t.Location.AlignH = AlignH.Left;
                    t.Location.AlignV = AlignV.Top;
                    t.FontSpec.Border.IsVisible = false;
